...
#      '#@REB_01@': 'PKG_CHECK_MODULES([CACA], [caca])',
      '#@REB_02@': 'pear1_REQUIRES="fructose"',
    ...
    ( 'orange-6.5.4-3', 'templatedepends', '1.2.3', {
      '#@REB_02@': 'orange1_REQUIRES="fructose"',
      '#@REB_03@': 'AC_SUBST(orange1_REQUIRES)',
      '#@REB_04@': 'orange1_LIBS="poto_libs"',
      '#@REB_05@': 'AC_SUBST(orange1_LIBS)',
      '#@REB_06@': 'orange1_LIBS_PRIVATE="poto_libs_private"',
      '#@REB_07@': 'AC_SUBST(orange1_LIBS_PRIVATE)',
      '#@REB_08@': 'orange1_CFLAGS="poto_cflags"',
      '#@REB_09@': 'AC_SUBST(orange1_CFLAGS)',
      '#@REB_10@': 'orange2_REQUIRES="fiber"',
      '#@REB_11@': 'AC_SUBST(orange2_REQUIRES)',
      '#@REB_12@': 'orange2_LIBS="poto_libs"',
      '#@REB_13@': 'AC_SUBST(orange2_LIBS)',
      '#@REB_14@': 'orange2_LIBS_PRIVATE="poto_libs_private"',
      '#@REB_15@': 'AC_SUBST(orange2_LIBS_PRIVATE)',
      '#@REB_16@': 'orange2_CFLAGS="poto_cflags"',
