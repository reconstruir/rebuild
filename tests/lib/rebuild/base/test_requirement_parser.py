...
class test_requirement_parser(unit_test):
  ...
  def test_simple(self):
    ...
    requirements = self._parse(text)
    self.assertEqual( [
      ( 'apple', '>=', '1.2.3', None, None ),
      ( 'kiwi', None, None, None, None ),
      ( 'pear', None, None, None, None ),
      ( 'lychee', None, None, None, None ),
      ( 'bananna', None, None, None, None ),
      ( 'kiwi-foo', None, None, None, None ),
      ( 'orange', '>=', '6.6.6', None, None ),
      ( 'strawberry', '>=', '1.9', None, None ),
    ], requirements )
