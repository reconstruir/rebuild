...
class test_build_system(unit_test):
  ...
  def test_resolve_mask(self):
    ...
    self.assertEqual( 'android|ios|ios_sim|linux|macos', BS.resolve_mask('all') )
    ...
    self.assertEqual( 'linux|macos', BS.resolve_mask('desktop') )
    self.assertEqual( 'ios|ios_sim|macos', BS.resolve_mask('darwin') )

  def test_resolve_mask_recursive(self):
    self.assertEqual( 'android|ios|ios_sim|linux|macos', BS.resolve_mask('darwin|desktop|mobile') )
