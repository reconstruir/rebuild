...
class test_masked_value_list(unit_test):
  ...
  @classmethod
  def _int(clazz, s):
    return V.parse_mask_and_value(clazz.TEST_ENV, '<none>', s, value_type.INT)
    
  @classmethod
  def _string(clazz, s):
    return V.parse_mask_and_value(clazz.TEST_ENV, '<none>', s, value_type.STRING)
    
  @classmethod
  def _bool(clazz, s):
    return V.parse_mask_and_value(clazz.TEST_ENV, '<none>', s, value_type.BOOL)
    
  @classmethod
  def _string_list(clazz, s):
    return V.parse_mask_and_value(clazz.TEST_ENV, '<none>', s, value_type.STRING_LIST)
    
  @classmethod
  def _key_values(clazz, s):
    return V.parse_mask_and_value(clazz.TEST_ENV, '<none>', s, value_type.KEY_VALUES)
