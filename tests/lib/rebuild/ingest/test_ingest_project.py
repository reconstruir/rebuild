...
entry libapple 2.3.4
  ...
  variables
    all: _home_url=http://example.com/apple
    all: _upstream_name=apple
  ...
  method http
    all: url=http://www.examples.com/apple.zip
    all: checksum=chk
    all: ingested_filename=apple.zip
'''

    content_orange = '''!rebuild.ingest.v1!
entry libapple 5.6.7
