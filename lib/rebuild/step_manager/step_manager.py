...
class step_manager(object):
  ...
  def add_step(self, description, packager_env):
    ...
    parsed_args = description.step_class.parse_step_args(packager_env, description.args)
  ...
  def add_steps(self, descriptions, packager_env):
